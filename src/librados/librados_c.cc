...
///////////////////////////// C API //////////////////////////////
/**
 * 创建一个 CephContext 对象，用于初始化和配置 Ceph 集群的客户端
 * @param clustername 集群名称，如果为 nullptr，则使用默认名称
 * @param iparams 初始化参数
 * @return 返回创建的 CephContext 对象
 */
  ...
  CephInitParameters *iparams)
{
  ...
  // 调用 common_preinit 函数进行初始化，该函数会创建一个新的 CephContext 对象
